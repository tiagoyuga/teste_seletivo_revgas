...
class ApiBankController extends ApiBaseController
{
    ...
    public function index(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendPaginate(new BankCollection($data));
    ...
    public function all(): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(BankResource::collection($data));
    ...
    public function show(int $id): JsonResponse
    {
        ...
        try {
            ...
            return $this->sendResource(new BankResource($item));
    ...
    public function store()
    {
        try {
            ...
            $storeRequest = new ClinicStoreRequest();
    ...
    public function update()
    {
        try {
            ...
            if (!\Auth::user()->can('update', Clinic::class)) {

                return $this->sendUnauthorized();
            }

            $updateRequest = new ClinicUpdateRequest();
