...
class ApiBaseController extends Controller
{
    ...
    public function destroy_api($id, $service, $model): JsonResponse
    {
        ...
        try {
            ...
            #$this->authorize('viewAny', SpecializedService::class);
            $this->authorize('viewAny', $model);

            /*if (!\Auth::user()->can('delete', $specializedService)) {

                return $this->sendUnauthorized();
            }*/

            #$this->service->delete($specializedService->find($id));
            $service->delete($service->find((int)$id));
